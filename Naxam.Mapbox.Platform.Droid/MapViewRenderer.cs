...
namespace Naxam.Controls.Mapbox.Platform.Droid
{
    public partial class MapViewRenderer : ViewRenderer<MapView, View>, IOnMapReadyCallback
    {
        ...
        public void OnMapReady(MapboxMap mapBox)
        {
            ...
            //map.SetStyle("https://rmap2.realis.si/lokacija.si.app/assets/res/mb-styles/vector.mb-style.json", null);
            //map.StyleUrl = "https://rmap2.realis.si/lokacija.si.app/assets/res/mb-styles/vector.mb-style.json";
            map.SetStyle("http://mpromet-dars.geoprostor.net/mapbox/assets/res/mb-styles/vector.mb-style.json");

            //Bitmap icon = BitmapFactory.DecodeResource(Resources, Resources.GetIdentifier("icon", "drawable", "net.naxam.mapboxqs"));
            //map.AddImage("pin", icon);
